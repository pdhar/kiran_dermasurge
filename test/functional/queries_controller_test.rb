...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { email: @query.email, message: @query.message, name: @query.name, subject: @query.subject }
    end
  ...
  test "should update query" do
    put :update, id: @query, query: { email: @query.email, message: @query.message, name: @query.name, subject: @query.subject }
    assert_redirected_to query_path(assigns(:query))
  end
